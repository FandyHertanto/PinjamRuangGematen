            ...
            <div class="modal-body">
                <form id="messageForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="recipient-name" readonly hidden>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form id="rejectMessageForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="reject-recipient-name" name="recipient-name" readonly hidden>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
