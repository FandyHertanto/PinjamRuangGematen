...
<style>
    .fc-event {
        background-color: transparent !important; /* Menghilangkan background default */
        border: none !important; /* Menghilangkan border default */
        box-shadow: none !important; /* Menghilangkan box-shadow default */
    }
    .custom-event-content {
        ...
        color: #000000;
        border-radius: 5px;
        transition: background-color 0.3s; /* Tambahkan efek transisi untuk perubahan background */
    }
